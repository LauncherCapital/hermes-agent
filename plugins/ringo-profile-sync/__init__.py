"""Deterministic IE profile synchronization service plugin."""
...
from .sync import ProfileSyncService


_service = ProfileSyncService(get_hermes_home())
...
def register(ctx) -> None:
    ctx.register_action("ringo.profile.reconcile", _reconcile)
